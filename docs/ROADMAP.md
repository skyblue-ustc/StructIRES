...
- [x] Complete reconstructed random-split composition and hashed k-mer pilots.
- [ ] Restore/version-pin the historical custom HoPE implementation before accepting any local
  RNA-AR frozen-embedding result.
