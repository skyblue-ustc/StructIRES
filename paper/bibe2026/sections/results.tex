...
The proposed \textsc{StructIRES-Classifier} will test whether thermodynamic
ensemble descriptors add held-out discrimination beyond sequence-only
foundation-model scores. Its result cells are intentionally TBD in this draft:
no improvement is claimed until the frozen train/validation/test evaluation is
completed. This separation prevents recognition development from using either
direct-RNA labels or design-stage outcomes for model selection.
