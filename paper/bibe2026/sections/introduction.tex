...
We present \textsc{StructIRES-Rank}, a generator-agnostic constrained
rank-selection method for seeded full-length IRES optimization. It makes three
contributions:
\begin{enumerate}
  \item It combines sequence plausibility with parent-relative energy,
  thermodynamic ensemble, and ensemble-anchor preservation.
  \item It evaluates all alternatives on identical frozen candidate pools and
